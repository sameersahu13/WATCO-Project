...
//---------------- Scroll to div ----------------
$('table.table').find('a').click(function(){
...
$(document).ready(function () {
    ...
    $("#panel-fullscreen").click(function (e) {
        ...
        if ($this.children('i').hasClass('mdi-fullscreen'))
        {
            $this.children('i').removeClass('mdi-fullscreen');
            $this.children('i').addClass('mdi-fullscreen-exit');
        }
        else if ($this.children('i').hasClass('mdi-fullscreen-exit'))
        {
            $this.children('i').removeClass('mdi-fullscreen-exit');
            $this.children('i').addClass('mdi-fullscreen');
        }
...
//---------------- Toggle left to right with icon rotate ----------------
$(function(){
    $('#queryBtn').click(function(){
       $('#queryContent').animate({'width': 'toggle', 'height': 'toggle'});
    });
    // $(".rotate").click(function(){
    $(".fixin").click(function(){
