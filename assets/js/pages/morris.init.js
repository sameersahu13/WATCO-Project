!(function (e) {
    ...
    (a.prototype.createLineChart = function (e, a, r, t, i, o, b, s, y) {
        ...
        (a.prototype.init = function () {
            ...
            // );
            this.createBarChart(
                "morris-bar-chart-example",
                [
                    { y: "Total Grievance", a: 100, b: 90, c: 40 },
                    { y: "Disposed", a: 75, b: 65, c: 20 },
                    { y: "Pending", a: 50, b: 40, c: 50 },
                    { y: "Repeated", a: 75, b: 65, c: 95 },
                    { y: "Fake", a: 100, b: 90, c: 60 },
                ],
                "y",
                ["a", "b", "c"],
                ["Month A", "Month B", "Month C"],
                ["#3ac9d6", "#ff9800", "#7fc1fc"]
            );
