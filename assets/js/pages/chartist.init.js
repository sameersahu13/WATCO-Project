...
new Chartist.Bar("#overlapping-bars", data, options, responsiveOptions), new Chartist.Bar("#multi-line-chart", {
    labels: ["Section 1", "Secton 2", "Section 3"],
    series: [
        [18, 27, 32],
        [20, 29, 33],
        [22, 35, 37]
...
data = {
    labels: ["Transmission Main", "Transmission Main", "Transmission Main"],
    series: [20, 15, 40]
}, options = {
    labelInterpolationFnc: function(e) {
        return e[0]
...
new Chartist.Pie("", data, options, responsiveOptions), new Chartist.Pie("#gauge-chart", {
    series: [20, 10, 30, 40]
}, {
    donut: !0,
    donutWidth: 60,
